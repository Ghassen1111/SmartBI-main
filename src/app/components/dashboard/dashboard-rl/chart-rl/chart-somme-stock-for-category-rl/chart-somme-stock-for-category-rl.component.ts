...
@Component({
  selector: 'app-chart-somme-stock-for-category-rl',
  templateUrl: './chart-somme-stock-for-category-rl.component.html',
  styleUrls: ['./chart-somme-stock-for-category-rl.component.css']
})
export class ChartSommeStockForCategoryRlComponent implements OnInit {
  polarAreaChart: any;
  colors = [];
  allCategory = [];
  allProducts = [];
        ...
        (Response) => {
          ...
          this.rlService.getAllProductsById(this.userId).subscribe(
            (Response) => {
              ...
              this.polarAreaChart = new Chart('polarAreaChartSommeStockForCategory', {
                type: 'polarArea',
                data: {
